...
| Workflow | Триггер | Проверяет | Время |
|----------|---------|-----------|-------|
| **build-linux** | Push/Tag/PR | ✓ Linux сборка | ~7-10 мин |
| **lint** | Push/PR | ✓ TypeScript ✓ Rust | ~2-3 мин |
| **pr-checks** | PR | ✓ Все проверки | ~7-10 мин |
| **release** | Tag v* | ✓ GitHub Release | ~1 мин |
...
✅ **Автоматические GitHub Releases** с AppImage для каждого тага
